...
describe('testing singlyLinkedList', function(){
  test('new SLL should create a node', () => {
    let node = new SLL(4);
  ...
  test('SLL.fromArray should return a linked list', () => {
  ...
  test('SLL.append(list, node, should append node to list', () => {
    let head = new SLL(0);
  ...
  test('node.append(value), should append node to list', () => {
    let head = new SLL(0)
  ...
  test('SLL.prepend(list, node) should return a list with node as head', () => {
  ...
  test('list.prepend(node) should return a list with node as head', () => {
    let list = SLL.fromArray([0, 4, 5])
    let head = new SLL(-1);
  ...
  test('SLL.remove(list, node) should remove a list with node as head', () => {
  ...
  test('list.remove(node) should remove a list with node as head', () => {
    let removeMe = new SLL('delete');
    let head = new SLL('head');
  ...
  test('SLL.getMiddle(list) should return middle node', () => {
    let list = SLL.fromArray([4, 5, 6]);

...
Javascript has a limited number of built in data types including objects, arrays, strings, numbers, and booleans. Data Modeling in Javscript is the process of taking a real world or conceptual model and encoding it into Javascripts Built in types. There isnt technicaly a write or wrong way to model data in software development, because it has been proven that any thing can be represented using any data structure or type. However it is important to follow several practices to boost software readbility and maintainability. Objects should be used when you have multiple pieces of data with different types. Arrays should be used when you have multiple pieces of data of like type. Booleans should be used when the data can have only two states. Numbers should be used when the data could support arithmatic opperaions. Strings should be used when the data is representing natrual language. 

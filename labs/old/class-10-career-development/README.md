...
####  Documentation  
  * in your README, document each your implementation of the Singly Linked List Data Structure
...
#### Feature Tasks  
  * complete the Singly Linked List data structure by adding a `remove()` method
  * implement `reverse()` as a method on the Singly Linked List prototype; from your whiteboard exercise
  * in comments above or within each function, note the Big-O runtime

## Bonus Points:
  * 2pts
  * implement `findNthNodeFromEnd()` as a method on the SLL prototype
